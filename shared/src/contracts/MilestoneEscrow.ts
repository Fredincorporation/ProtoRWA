 ...
 * Source: contracts/out/MilestoneEscrow.sol/MilestoneEscrow.json
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct MilestoneEscrow.Review",
        "components": [
          {
            "name": "open",
            "type": "bool",
          ...
          },
          {
            "name": "outcome",
            "type": "uint8",
            "internalType": "enum MilestoneEscrow.ReviewOutcome"
          }
        ]
      }
    ],
...
export type MilestoneEscrowAbi = typeof milestoneEscrowAbi;
